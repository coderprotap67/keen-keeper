...
export default function FriendDetails() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 py-10 px-6
     md:px-10 lg:px-20 bg-[#F8FAFC] gap-6 min-h-screen">


      <div className="flex flex-col gap-4">
        <div className="flex flex-col items-center justify-center bg-white rounded-xl border
         border-slate-200 p-8 shadow-none">
          <img
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {expectedFriend.tags.map((tag, index) => (
              <div key={index} className="badge bg-[#CBFADB] text-[#244D3F]
               border-0 rounded-full font-medium text-[10px] px-3">
                {tag.toUpperCase()}
              </div>
            ))}
          </div>
        ...
        <div className="flex flex-col gap-2">
          <button className="btn bg-white border border-slate-200 shadow-none
           hover:bg-slate-50 normal-case font-medium text-slate-600">
          ...
          <button className="btn bg-[#FFF1F2] border border-rose-100 shadow-none
           hover:bg-rose-100 normal-case font-bold text-rose-600">
      ...
      <div className="md:col-span-2">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          <div className="bg-white p-6 flex flex-col items-center justify-center
           rounded-xl border border-slate-200 shadow-none text-center">
